...
class CountryChooseAdapter(private val countryList: List<String>,
                           private val context: Context,
                           alreadySelectedCountry:String,
                           private val adapterOnClick: (String) -> Unit  ) : RecyclerView.Adapter<CountryChooseAdapter.ViewHolder>() {
    ...
    inner class ViewHolder( itemView:View):RecyclerView.ViewHolder(itemView){
        ...
        fun setItem(country:String,position: Int){
            countryImageView.setOnClickListener {
                selectedCountry.postValue(countryList[position])
    ...
    private val selectedCountry = MutableLiveData(alreadySelectedCountry).also {
        it.observeForever {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        if (countryList[position] == selectedCountry.value){
